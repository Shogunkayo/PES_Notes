...
### Register windows
- RISC processors incorporated a large number of regiisters.
- Procedure entry and exit instrucctions moved the visible 'window' to give each procedure access to new register
- Large chip area was occupiied by large number of registers

### Delayed branches
- Branches cause pipeline problems since they interrupt the smoot flow of instructions
